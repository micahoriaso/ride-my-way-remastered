...
export class initial1551183454477 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "ride" ("id" SERIAL NOT NULL, "time" character varying NOT NULL, "date" character varying NOT NULL, "pickup" character varying NOT NULL, "dropoff" character varying NOT NULL, "capacity" integer NOT NULL, "seats_available" integer NOT NULL, "price" money NOT NULL, "status" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "driverId" uuid, CONSTRAINT "PK_f6bc30c4dd875370bafcb54af1b" PRIMARY KEY ("id"))`);
