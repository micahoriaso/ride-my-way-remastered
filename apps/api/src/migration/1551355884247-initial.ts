...
export class initial1551355884247 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "ride_request" ("id" SERIAL NOT NULL, "ride" character varying NOT NULL, "requestor" character varying NOT NULL, "status" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "rideId" integer, "requestorId" uuid, CONSTRAINT "PK_f5d356576522e43e56a3a0e906b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "ride_status_enum" AS ENUM('IN_OFFER', 'STARTED', 'DONE', 'CANCELLED')`);
        await queryRunner.query(`CREATE TABLE "ride" ("id" SERIAL NOT NULL, "time" character varying NOT NULL, "date" character varying NOT NULL, "pickup" character varying NOT NULL, "dropoff" character varying NOT NULL, "capacity" integer NOT NULL, "seats_available" integer NOT NULL, "price" money NOT NULL, "status" "ride_status_enum" NOT NULL DEFAULT 'IN_OFFER', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "driverId" uuid, CONSTRAINT "PK_f6bc30c4dd875370bafcb54af1b" PRIMARY KEY ("id"))`);
